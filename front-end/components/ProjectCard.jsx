        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-10 gap-y-16 pt-5 sm:pt-2 text-white">
          <div className="bg-gray-300 rounded shadow-2xl">
            <div className="p-8 text-center">
              <img className="pt-2 mt-4 hero container max-w-screen-lg mx-auto pb-10 flex h-48 w-96 md:w-[259px] md:h-[289px]"></img>
          ...
          <div className="bg-gray-300 rounded shadow-2xl">
            <div className="p-8 text-center">
              <img className="pt-2 mt-4 hero container max-w-screen-lg mx-auto pb-10 flex w-[200px] h-[230px] md:w-[259px] md:h-[289px]"></img>
              <div className="pl-2 font-bold font-Inter text-black text-[20px] md:text-[24px]">
                Project2
              </div>
            </div>
